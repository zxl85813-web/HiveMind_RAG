...
async def test_agentic_search():
    ...
    try:
        from backend.app.agents.agentic_search import list_files_recursive, grep_search, read_file_range
...
async def test_native_tools():
    ...
    try:
        ...
        from backend.app.agents.tools import think, python_interpreter, search_available_tools
