...
class LightweightRedisTracer(AsyncCallbackHandler):
    ...
    async def on_llm_error(
        self, error: Exception | KeyboardInterrupt, *, run_id: UUID, parent_run_id: Optional[UUID] = None, **kwargs: Any
    ) -> None:
        span_data = {
            "trace_id": self.trace_id,
            "agent_name": self.agent_name,
    ...
    async def on_tool_start(
        self, serialized: Dict[str, Any], input_str: str, *, run_id: UUID, parent_run_id: Optional[UUID] = None, tags: Optional[List[str]] = None, metadata: Optional[Dict[str, Any]] = None, inputs: Optional[Dict[str, Any]] = None, **kwargs: Any
    ) -> None:
        pass
