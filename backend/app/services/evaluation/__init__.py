...
from app.models.evaluation import EvaluationSet, EvaluationItem, EvaluationReport
from app.models.knowledge import KnowledgeBase, DocumentChunk, KnowledgeBaseDocumentLink
...
class EvaluationService:
    ...
    async def run_evaluation(
        ...
        if faith_scores:
            ...
            report.total_score = (report.faithfulness + report.answer_relevance + report.context_precision + report.context_recall) / 4
        ...
        logger.info(f"✅ Evaluation complete for {target_model}: Score={report.total_score:.2f}, Cost=${report.cost:.4f}")
        return report
