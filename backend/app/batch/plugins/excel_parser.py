...
from app.batch.ingestion.protocol import ResourceMetadata, ResourceType, StandardizedResource, TableData
    ...
    async def parse(self, file_path: str, context: IngestionContext | None = None) -> StandardizedResource:
        ...
        return StandardizedResource(
            meta=ResourceMetadata(
                filename=file_path.split("/")[-1], file_path=file_path, resource_type=ResourceType.BASIC_DESIGN
            ),
