...
from app.batch.ingestion.protocol import StandardizedResource, ResourceMetadata, ResourceType, ImageContent
...
class ImageParser(BaseParser):
    ...
    async def parse(self, file_path: str, context: IngestionContext = None) -> StandardizedResource:
        ...
        if self.model:
            try:
                ...
                message = HumanMessage(
                    content=[
                        {"type": "text", "text": "Describe this image in detail for a knowledge base. Extract any visible text entirely. If it's a diagram, describe the relationships."},
                        {
                            "type": "image_url",
        ...
        resource.images.append(ImageContent(
