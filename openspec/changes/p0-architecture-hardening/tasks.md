...
| **T2.2** | Implement `app.sdk.core.token_service.TokenService` with `truncate_context` | `token_service.py` | ✅ |
| **T2.3** | Update `app.sdk.core.config.Settings` with budget constants | `config.py` (updated) | ✅ |
