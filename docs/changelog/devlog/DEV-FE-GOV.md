...
| 2 | **场景 1：并发会话隔离** | `frontend/e2e/isolation.spec.ts` | ✅ | 0.5h |
| 3 | **场景 2：连接生命周期熔断**| `frontend/e2e/lifecycle.spec.ts` | ✅ | 0.5h |
| 5 | **场景 4：追踪链路对账** | `frontend/e2e/tracing.spec.ts` | ✅ | 0.3h |
| 6 | **场景 5：401 故障级联**：拦截短连接 401 触发长连接熔断测试 | `frontend/e2e/cascade.spec.ts` | ⬜ | - |
