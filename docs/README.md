...
- **[RAG_EVALUATION_FRAMEWORK.md](./evaluation/RAG_EVALUATION_FRAMEWORK.md)** — RAG 三层分层评测 (L1 Retriever / L2 Generator / L3 E2E) + LLM-as-Judge 偏差治理。
- **[AGENT_EVALUATION_FRAMEWORK.md](./evaluation/AGENT_EVALUATION_FRAMEWORK.md)** — Agent 四层分层评测 (L1 单体 / L2 协作 / L3 能力 / L4 过程完整性)。
- **[EVALUATION_SYSTEM_AUDIT.md](./evaluation/EVALUATION_SYSTEM_AUDIT.md)** — 🆕 评估体系深度审计报告：7 个结构性缺陷诊断 + 改造路线图。
- **[METRICS_CHEATSHEET.md](./evaluation/METRICS_CHEATSHEET.md)** — RAG 评测指标速查表 + 诊断流程图。
- **[AGENT_METRICS_CHEATSHEET.md](./evaluation/AGENT_METRICS_CHEATSHEET.md)** — Agent 评测指标速查表 + L4 审计结果解读。
- **[L3_QUALITY_BOARD.md](./evaluation/L3_QUALITY_BOARD.md)** — L3 智体能力质量看板 (自动生成)。
- **[L4_INTEGRITY_REPORT.md](./evaluation/L4_INTEGRITY_REPORT.md)** — L4 过程完整性审计报告 (自动生成)。
